...
namespace CapaPresentacion
{
    public partial class FrmCliente : Form
    {
        ...
        {
            this.dataListado.Columns["idCliente"].DisplayIndex = 0;
            this.dataListado.Columns["idCliente"].HeaderText = "id";            
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NCliente.Insertar(this.txtNombre.Text.Trim(),this.txtPaterno.Text.Trim(),this.txtMaterno.Text.Trim(), Convert.ToInt32(this.txtTelefono.Text.Trim()),this.txtCI.Text.Trim());
                    }
                    else
                    {
                        rpta = NCliente.Editar(Convert.ToInt32(this.txtIdCliente.Text), this.txtNombre.Text.Trim(),this.txtPaterno.Text.Trim(), this.txtMaterno.Text.Trim(), Convert.ToInt32(this.txtTelefono.Text.Trim()), this.txtCI.Text.Trim());
                    }
        ...
        private void dataListado_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == dataListado.Columns["Eliminar"].Index)
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    Codigo = Convert.ToString(this.dataListado.CurrentRow.Cells["idCliente"].Value);
