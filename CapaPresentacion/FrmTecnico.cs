...
namespace CapaPresentacion
{
    public partial class FrmTecnico : Form
    {
        ...
        {
            this.txtIdTecnico.Text = string.Empty;
        ...
        {
            this.txtIdTecnico.ReadOnly = !valor;
        ...
        {
            this.dataListado.Columns["idTecnico"].DisplayIndex = 0;
            this.dataListado.Columns["idTecnico"].HeaderText = "id";
        ...
        {
            this.dataListado.DataSource = NTecnico.Mostrar();
        ...
        {
            this.dataListado.DataSource = NTecnico.BuscarNombre(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registro: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NTecnico.Insertar(this.txtNombre.Text.Trim(), this.txtPaterno.Text.Trim(), this.txtMaterno.Text.Trim(), Convert.ToInt32(this.txtTelefono.Text.Trim()), this.txtCI.Text.Trim());
                    }
                    else
                    {
                        rpta = NTecnico.Editar(Convert.ToInt32(this.txtIdTecnico.Text), this.txtNombre.Text.Trim(), this.txtPaterno.Text.Trim(), this.txtMaterno.Text.Trim(), Convert.ToInt32(this.txtTelefono.Text.Trim()), this.txtCI.Text.Trim());
                    }
        ...
        private void dataListado_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == dataListado.Columns["Eliminar"].Index)
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    Codigo = Convert.ToString(this.dataListado.CurrentRow.Cells["idTecnico"].Value);
                    Rpta = NTecnico.Eliminar(Convert.ToInt32(Codigo));
            ...
            else
            {
                ...
                {
                    this.txtIdTecnico.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["idTecnico"].Value);
